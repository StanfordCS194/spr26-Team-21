...
export interface ExactMatchPrivacyCheck {
  matchCount: number;
  matchPct: number;
  rowsChecked: number;
...
export interface NearestNeighborPrivacyCheck {
...
export interface PrivacyValidation {
  exactMatch?: ExactMatchPrivacyCheck | null;
  nearestNeighbor?: NearestNeighborPrivacyCheck | null;
}
